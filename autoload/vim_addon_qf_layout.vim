...
"let abc = fnamemodify(bufname(l.bufnr), ":h")
"echo abc 
"let abc2 = fnamemodify(bufname(l.bufnr), ":p:h")
"echo abc2 

chdir $mmu
let l.filename = fnamemodify(bufname(l.bufnr), ":h")."/".fnamemodify(bufname(l.bufnr), ":t")
...
fun! vim_addon_qf_layout#FileFormatter()
  let list = copy(vim_addon_qf_layout#GetList())
  " not sure whether copy is needed. I once had a segfault.. maybe its
  " obsolete nowadays.
